...
public class EditBookingEquipmentTask extends Task<Boolean> {

    private final Booking booking;
    private final BookingTime bookingTime;
    private final BookingDao bookingDao;

    public EditBookingEquipmentTask(Booking booking, BookingTime bookingTime) {
    ...
    public Boolean call() {
        ...
        try {
            bookingDao.editBooking(booking, bookingTime); // TODO: Implement editBookingEquipment
        }
